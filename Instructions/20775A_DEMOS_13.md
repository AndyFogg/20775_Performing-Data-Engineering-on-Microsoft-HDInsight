...
3.  Using Internet Explorer, download **winutils.exe** file from **https://github.com/steveloughran/winutils/blob/master/hadoop-2.6.0/bin/winutils.exe**, and save the file in the **E:\Demofiles\Hadoop\bin** folder.
...
59. In the **IDE and Plugin Updates** dialog box, click **Restart**.
60. On the **File** menu, click **Open**.
61. In the **Open File or Project** dialog box, navigate to the **E:\\Demofiles\\Mod13** folder, click **StockMarketSocketSender**, and then click **OK**.
62. In the **Open Project** dialog box, click **This Window**.
63. If the **Project JDK is not defined** message appears, complete the following steps:
    1.  Click **Setup JDK**.
    2.  In the **Select Project SDK** dialog box, click **11**, and then click **OK**.
64. If the **No Scala SDK in module** message appears, complete the following steps:
    1.  Click **Setup Scala SDK**.
    2.  In the **Add Scala Support** dialog box, ensure **scala-sdk-2.12.7** is selected, and then click **OK**.
65. In the main pane, close any open tabs.
66. On the **File** menu, click **Save All**.
67. On the **File** menu, click **Close Project**.
68. In the **Welcome to IntelliJ IDEA** window, click **Open**.
69. In the **Open File or Project** dialog box, navigate to the **E:\\Demofiles\\Mod13** folder, click  **StockMarketSocketSender**, and then click **OK**.
70. In the **Open Project** dialog box, click **This Window**.
71. If the **Project JDK is not defined** message appears, complete the following steps:
    1.  Click **Setup JDK**.
    2.  In the **Select Project SDK** dialog box, click **11**, and then click **OK**.
72. If the **No Scala SDK in  module** message appears, complete the following steps:
    1.  Click **Setup Scala SDK**.
    2.  In the **Add Scala Support** dialog box, ensure **scala-sdk-2.12.7** is selected, and then click **OK**.
73. In the main pane, close any open tabs.
74. On the **File** menu, click **Save All**.
75. In the **Welcome to IntelliJ IDEA** window, click **Open**.
76. In the **Open File or Project** dialog box, navigate to the **E:\\Demofiles\\Mod13** folder, click  **StockMarketStreamProcessor**, and then click **OK**.
77. In the **Open Project** dialog box, click **This Window**.
78. If the **Project JDK is not defined** message appears, complete the following steps:
    1.  Click **Setup JDK**.
    2.  In the **Select Project SDK** dialog box, click **11**, and then click **OK**.
79. If the **No Scala SDK in  module** message appears, complete the following steps:
    1.  Click **Setup Scala SDK**.
    2.  In the **Add Scala Support** dialog box, ensure **scala-sdk-2.12.7** is selected, and then click **OK**.
80. In the main pane, close any open tabs.
81. On the **File** menu, click **Save All**.
82. Close IntelliJ IDEA.
