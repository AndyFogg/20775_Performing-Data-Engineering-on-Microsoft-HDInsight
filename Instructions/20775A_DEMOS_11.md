...
> **Note**: If you already have all these components installed in the 20775A-LON-DEV virtual machine, you can skip the preperation section.
...
51. In the **Plugins** pane, clear **Android Support**, and then click **Browse repositories**.
52. In the **Browse Repositories** dialog box, in the search box, type **Azure**.
53. Click **Azure Toolkit for IntelliJ**, and then click **Install**.
54. In the **Third-party Plugins Privacy Note** dialog box, click **Accept**.
55. In the **Browse Repositories** dialog box, click **Close**.
56. In the **Settings** dialog box, click **OK**.
57. In the **IDE and Plugin Updates** dialog box, click **Postpone**.
58. Close IntelliJ IDEA.
59. In the **Confirm Exit** dialog box, click **Exit**.
